...
def getHtml(keyword,start):
	...
	url='http://image.baidu.com/search/acjson?tn=resultjson_com&ipn=rj&ct=201326592&is=&fp=result' \
		...
		'&word='+keyword+'&s=0&se=&tab=&width=&height=&face=1&istype=2&qc=&nc=&fr=%26fr%3D&pn='+str(start)+'&rn=60&1433936881420='
...
keywords_list = [#'1个月宝宝', '2个月宝宝', '3个月宝宝', '4个月宝宝', '5个月宝宝', '6个月宝宝', '7个月宝宝', '8个月宝宝', '9个月宝宝', '10个月宝宝', '11个月宝宝', '12个月宝宝',
...
step=60
#保存图片路径
img_path = 'D:/AgeDatabaseConstruct/DataBase/baidu1'
#保存爬取图片的信息路径
txt_path = 'D:/AgeDatabaseConstruct/LinkInfo/baidu1'
